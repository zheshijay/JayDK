...
public class UniversityCareerFairTest {

//	int maxEvents(int[] arrival, int[] duration) {
//		int maxEvents = 1, len = arrival.length;
//		
//		int preEndTime = arrival[0] + duration[0];
//		for(int i=1; i<len; i++) {
//			if (arrival[i] >= preEndTime) {
//				maxEvents++;
//				preEndTime = arrival[i] + duration[i];
//			}
//		}
//		
//		return maxEvents;
//	}
	...
	public static void main(String[] args) {
		UniversityCareerFairTest test = new UniversityCareerFairTest();
